...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Notice::create([
            ...
            'content' => 'রেশমা ইন্টারন্যাশনাল স্কুলে ২০২৫-২০২৬ শিক্ষাবর্ষের ভর্তি চলছে। সকল শ্রেণিতে সীমিত আসন রয়েছে। আগ্রহী অভিভাবকরা যত তাড়াতাড়ি সম্ভব ভর্তির জন্য আবেদন করুন।',
            'type' => 'notice',
            'target_role' => 'all',
