...
@section('content')
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">শ্রেণি ও তারিখ অনুযায়ী উপস্থিতির রিপোর্ট দেখুন</p>
        </div>
                        ...
                        @forelse($attendances as $index => $attendance)
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-5 py-3.5 text-gray-500">
                                    {{ ($attendances->currentPage() - 1) * $attendances->perPage() + $index + 1 }}</td>
                                ...
                                <td class="px-5 py-3.5">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span
                                            class="font-medium text-gray-900">{{ $attendance->student->name_bn ?? '-' }}</span>
                                    </div>
                                </td>
