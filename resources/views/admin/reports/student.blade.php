    ...
    <div class="space-y-6">
        ...
        @if (isset($selectedStudent))
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                <div class="flex items-center gap-4">
                    <div
                        class="w-16 h-16 rounded-full bg-ris-primary/10 flex items-center justify-center text-ris-primary text-2xl font-heading font-bold shrink-0">
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    @foreach ($results as $result)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-5 py-3 text-center text-gray-900 font-medium">
                                                {{ $result->marks ?? '-' }}</td>
                                            ...
                                            <td class="px-5 py-3 text-center text-gray-600">{{ $result->section ?? '-' }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        @else
            <div class="bg-white rounded-xl border border-gray-200 px-5 py-12 text-center">
                ...
                <p class="text-sm text-gray-400 mt-1">উপরের ফিল্টার ব্যবহার করে শ্রেণি ও ছাত্র নির্বাচন করুন</p>
            </div>
        @endif
