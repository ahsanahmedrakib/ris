...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">পরীক্ষার তালিকা, ফলাফল ও শ্রেণী অনুযায়ী পরীক্ষার সারসংক্ষেপ দেখুন</p>
    </div>
        ...
        <form method="GET">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('admin.reports.exams') }}" class="px-4 py-2.5 bg-gray-100 text-gray-600 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors">
                        রিসেট
                    </a>
                </div>
            </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($exams as $index => $exam)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-5 py-3.5 text-gray-500">{{ ($exams->currentPage() - 1) * $exams->perPage() + $index + 1 }}</td>
                            ...
                            <td class="px-5 py-3.5 text-gray-600">{{ $exam->date ? \Carbon\Carbon::parse($exam->date)->format('d/m/Y') : '-' }}</td>
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="{{ route('admin.exams.results', $exam) }}" class="p-1.5 rounded-lg text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-colors" title="ফলাফল দেখুন">
