    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">শ্রেণিভিত্তিক ফি কাঠামো তৈরি করুন</p>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">ফি-এর ধরন <span
                                    class="text-red-500">*</span></label>
                            <select name="fee_type" required
                                ...
                                @foreach ($feeTypes as $type)
                                    <option value="{{ $type->value }}"
                                        {{ old('fee_type') === $type->value ? 'selected' : '' }}>{{ $type->label() }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">পরিমাণ (৳) <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">শেষ তারিখ <span
                                    class="text-red-500">*</span></label>
                            <input type="text" data-date-mask name="due_date" value="{{ old('due_date') }}" required
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors">
                        </div>
                        <div>
