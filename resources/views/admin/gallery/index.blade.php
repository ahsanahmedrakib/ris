...
@section('title', 'গ্যালারি তালিকা')

@section('content')
    <div class="space-y-6" x-data="galleryApp()">

        {{-- Header --}}
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-heading font-bold text-gray-900">গ্যালারি</h1>
                <p class="text-sm text-gray-500 mt-1">স্কুলের ছবি পরিচালনা করুন</p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors"
                                ...
                                <td class="px-4 py-3">
                                    <button @click="openViewModal({{ $item->id }})"
                                        class="font-heading font-semibold text-ris-primary hover:underline cursor-pointer">{{ $item->title }}</button>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-5 py-12 text-center">
                                    ...
                                    <p class="text-gray-500 font-medium">কোনো ছবি পাওয়া যায়নি</p>
                                    <p class="text-sm text-gray-400 mt-1">নতুন ছবি যোগ করুন বা ফিল্টার পরিবর্তন করুন</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <div x-show="showCreateModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                ...
                <div class="gradient-logo px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="font-heading font-bold text-white text-lg">নতুন ছবি</h3>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="category"
                                ...
                                @foreach (['অনুষ্ঠান', 'ক্লাস', 'ক্রীড়া', 'সাংস্কৃতিক', 'বিজ্ঞান', 'ক্যাম্পাস'] as $category)
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="description" rows="3" x-model="createForm.description"
                                ...
                                placeholder="ছবির সংক্ষিপ্ত বিবরণ (ঐচ্ছিক)..."></textarea>
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <p class="mt-1 text-xs text-gray-400">JPG, PNG, WEBP — সর্বোচ্চ 5MB</p>
                        </div>
                        <div>
        ...
        <div x-show="showViewModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                class="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
                <div class="gradient-logo px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="font-heading font-bold text-white text-lg">ছবির তথ্য</h3>
        ...
        <div x-show="showEditModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                class="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
                <div class="gradient-logo px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="font-heading font-bold text-white text-lg">ছবি সম্পাদনা</h3>
                ...
                <div class="p-6">
                    <template x-if="editData">
                        <form :action="'{{ url('admin/gallery') }}/' + editData.id" method="POST"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <select name="category"
                                        ...
                                        @foreach (['অনুষ্ঠান', 'ক্লাস', 'ক্রীড়া', 'সাংস্কৃতিক', 'বিজ্ঞান', 'ক্যাম্পাস'] as $category)
                                            <option value="{{ $category }}"
                                                x-bind:selected="editData.category === '{{ $category }}'">{{ $category }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="file" name="image" accept="image/*"
                                        ...
                                        class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors bg-white">
                                    <p class="mt-1 text-xs text-gray-400">JPG, PNG, WEBP — সর্বোচ্চ 5MB। ফাইল নির্বাচন না করলে পুরাতন থাকবে।</p>
                                    <div class="mt-3 flex items-center gap-3">
                                        <img :src="editImagePreview || editData.image"
                                            class="w-20 h-14 rounded-lg object-cover border border-gray-200">
            ...
            function galleryApp() {
                return {
                    ...
                    openCreateModal() {
                        ...
                        this.createFormSelectedFile = false;
                    ...
                    async openViewModal(id) {
                        ...
                        this.viewData = null;
                        try {
                            const res = await fetch(`{{ url('admin/gallery') }}/${id}`);
                    ...
                    async openEditModal(id) {
                        ...
                        try {
                            const res = await fetch(`{{ url('admin/gallery') }}/${id}/edit`);
