...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-heading font-bold text-gray-900">ছাত্র সম্পাদনা</h1>
                <p class="text-sm text-gray-500 mt-1">{{ $student->name_bn ?? '' }} -এর তথ্য আপডেট করুন</p>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">ভর্তি নং <span
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">নাম (বাংলা) <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="name_bn" value="{{ old('name_bn', $student->name_bn ?? '') }}"
                                required
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">নাম (ইংরেজি) <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">নতুন পাসওয়ার্ড (খালি রাখুন
                                পরিবর্তন না করতে চাইলে)</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">লিঙ্গ <span
                                    class="text-red-500">*</span></label>
                            <select name="gender" required
                                ...
                                <option value="male"
                                    {{ old('gender', $student->gender ?? '') === 'male' ? 'selected' : '' }}>পুরুষ</option>
                                <option value="female"
                                    {{ old('gender', $student->gender ?? '') === 'female' ? 'selected' : '' }}>মহিলা
                                </option>
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            @if (!empty($student->photo))
                                <p class="text-xs text-gray-400 mt-1">বর্তমান: {{ $student->photo }}</p>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">রোল নং <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div class="sm:col-span-2 lg:col-span-3">
                            ...
                            <textarea name="address" rows="2"
                                class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors resize-none">{{ old('address', $student->address ?? '') }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">অভিভাবকের নাম <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">অভিভাবকের মোবাইল <span
                                    class="text-red-500">*</span></label>
