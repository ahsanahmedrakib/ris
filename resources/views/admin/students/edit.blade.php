            ...
            <div class="p-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name_bn" value="{{ old('name_bn', $student->name_bn ?? '') }}" required
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">নাম (ইংরেজি) <span class="text-red-500">*</span></label>
                        <input type="text" name="name_en" value="{{ old('name_en', $student->name_en ?? '') }}" required
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors">
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">নতুন পাসওয়ার্ড (খালি রাখুন পরিবর্তন না করতে চাইলে)</label>
            ...
            <div class="p-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="guardian_phone" value="{{ old('guardian_phone', $student->guardian_phone ?? '') }}" required
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors">
                    </div>
                    <div>
