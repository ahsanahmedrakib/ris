...
@section('title', 'নতুন শিক্ষক যোগ করুন')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="card p-6">
        <h1 class="text-xl font-heading font-bold text-ris-dark mb-1">নতুন শিক্ষক যোগ করুন</h1>
        <p class="text-sm text-gray-500 mb-6">শিক্ষকের তথ্য পূরণ করুন। ডিফল্ট পাসওয়ার্ড: password</p>
        ...
        <form method="POST" action="{{ route('admin.teachers.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="সম্পূর্ণ নাম লিখুন"
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" required placeholder="example@ris.edu.bd"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors">
