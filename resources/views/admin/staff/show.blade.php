            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-5 py-12 text-center text-gray-400 text-sm">এখনো কোনো বেতন স্লিপ
                                    নেই</td>
                            </tr>
                        @endforelse
                    </tbody>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-5 py-3.5">
                                    ...
                                    {{ $leave->status === 'approved' ? 'bg-emerald-50 text-emerald-700' : ($leave->status === 'rejected' ? 'bg-red-50 text-red-700' : 'bg-amber-50 text-amber-700') }}">
                                        {{ $leave->status === 'approved' ? 'অ্যাকসেপ্ট' : ($leave->status === 'rejected' ? 'বাতিল' : 'মুলতুবি') }}
                                    </span>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="px-5 py-12 text-center text-gray-400 text-sm">কোনো ছুটির আবেদন নেই
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
