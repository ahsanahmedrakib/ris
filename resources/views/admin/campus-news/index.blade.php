                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-5 py-12 text-center">
                                    ...
                                    <p class="text-gray-500 font-medium">কোনো আইটেম পাওয়া যায়নি</p>
                                    <p class="text-sm text-gray-400 mt-1">নতুন আইটেম যোগ করুন বা ফিল্টার পরিবর্তন করুন</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
            ...
            <div
                ...
                <form action="{{ route('admin.campus-news.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">তারিখ <span
                                    class="text-red-500">*</span></label>
                            <input type="date" name="date" x-model="createForm.date"
                                @blur="validateCreateField('date')"
                                class="w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors"
                                :class="(createErrors.date || (createAttempted && !createForm.date)) ? 'border-red-400' :
                                'border-gray-200'">
                            <template x-if="createErrors.date || (createAttempted && !createForm.date)">
                        ...
                        <div>
                            ...
                            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <dd class="font-medium text-gray-900" x-text="viewData.date || '-'"></dd>
                                </div>
                        ...
                        <form :action="'{{ url('admin/campus-news') }}/' + editData.id" method="POST"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">তারিখ <span
                                            class="text-red-500">*</span></label>
                                    <input type="date" name="date" x-model="editData.date"
                                        @blur="validateEditField('date')"
                                        class="w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors"
                ...
                return {
                    ...
                    validateField(field, data, errors) {
                        ...
                        if (['title', 'date'].includes(field)) {
                            if (!val || val.trim() === '') {
                                errors[field] = field === 'title' ? 'শিরোনাম আবশ্যক।' : 'তারিখ আবশ্যক।';
                                return false;
                            }
                        }
