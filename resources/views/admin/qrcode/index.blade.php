    ...
    <div class="grid lg:grid-cols-5 gap-6" x-data="qrGenerator()">
        ...
        <div class="lg:col-span-3 bg-white rounded-xl border border-gray-200 p-6">
            <form @submit.prevent="updateUrl()" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mt-3">
                            <button type="button" @click="color = '#a31c42'"
                                class="w-7 h-7 rounded-full border-2 border-gray-200 transition-transform hover:scale-110 cursor-pointer"
                ...
                <button type="submit"
                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-ris-primary text-white text-sm font-medium rounded-lg hover:bg-ris-dark transition-colors shadow-sm cursor-pointer">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 flex flex-col items-center">
                ...
                <div class="mt-5 flex flex-wrap items-center justify-center gap-3" x-show="url" x-cloak>
                    ...
                    <button type="button" @click="copyLink()"
                        class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors cursor-pointer">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
