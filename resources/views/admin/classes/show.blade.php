...
@section('title', 'শ্রেণী বিস্তারিত')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-heading font-bold text-gray-900">{{ $class->name }} @if($class->section)<span class="text-ris-primary text-lg">-{{ $class->section }}</span>@endif</h1>
                <p class="text-sm text-gray-500 mt-1">শ্রেণীর বিস্তারিত তথ্য</p>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.classes.edit', $class) }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-ris-primary text-white text-sm font-medium rounded-lg hover:bg-ris-dark transition-colors shadow-sm">
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    <p class="text-xs font-medium text-gray-400">শ্রেণী শিক্ষক</p>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-5 py-12 text-center text-gray-400 text-sm">এই শ্রেণীতে কোনো ছাত্র/ছাত্রী নেই</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-5 py-12 text-center text-gray-400 text-sm">এই শ্রেণীতে কোনো বিষয় নেই</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
