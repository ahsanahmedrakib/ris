...
@section('title', 'নতুন শ্রেণী যোগ করুন')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-heading font-bold text-gray-900">নতুন শ্রেণী যোগ করুন</h1>
            <p class="text-sm text-gray-500 mt-1">নতুন শ্রেণীর তথ্য ফর্ম পূরণ করুন</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.classes.store') }}" class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100">
                <h2 class="font-heading font-semibold text-gray-900 flex items-center gap-2">
                    <svg class="w-5 h-5 text-ris-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    শ্রেণীর তথ্য
                </h2>
            </div>
            <div class="p-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">শ্রেণীর নাম <span class="text-red-500">*</span></label>
                        <input type="text" name="name" value="{{ old('name') }}" required
                               ...
                               placeholder="যেমন: প্লে, নার্সারি, প্রথম">
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">শ্রেণী শিক্ষক</label>
                        <select name="class_teacher_id" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-ris-primary/20 focus:border-ris-primary outline-none transition-colors bg-white">
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('admin.classes.index') }}" class="px-5 py-2.5 bg-gray-100 text-gray-600 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors">
                বাতিল
            </a>
