...
@section('title', 'নতুন শ্রেণি যোগ করুন')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-heading font-bold text-gray-900">নতুন শ্রেণি যোগ করুন</h1>
                <p class="text-sm text-gray-500 mt-1">নতুন শ্রেণির তথ্য ফর্ম পূরণ করুন</p>
            </div>
        </div>
