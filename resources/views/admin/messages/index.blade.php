...
@section('title', 'বার্তা তালিকা')

@section('content')
    <div class="space-y-6" x-data="messageApp()">

        {{-- Header --}}
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-heading font-bold text-gray-900">বার্তা</h1>
                <p class="text-sm text-gray-500 mt-1">চেয়ারম্যান, প্রতিষ্ঠাতা ও অন্যান্য ব্যক্তির বাণী পরিচালনা করুন</p>
            </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}"
                                placeholder="শিরোনাম, নাম বা বার্তা দিয়ে খুঁজুন..."
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="gradient-logo">
                            ...
                            <th class="text-left px-4 py-3.5 font-medium text-white whitespace-nowrap">বাণী</th>
                            ...
                            <th class="text-left px-4 py-3.5 font-medium text-white whitespace-nowrap">ক্রম</th>
                    ...
                    <tbody class="divide-y divide-gray-50" data-table-body>
                        @forelse($messages as $message)
                            <tr class="hover:bg-gray-50 transition-colors"
                                ...
                                <td class="px-4 py-3">
                                    <button @click="openViewModal({{ $message->id }})"
                                        class="font-heading font-semibold text-ris-primary hover:underline cursor-pointer">{{ $message->title }}</button>
                                </td>
                                <td class="px-4 py-3 text-gray-800 whitespace-nowrap">{{ $message->name }}</td>
                                <td class="px-4 py-3 text-gray-600 whitespace-nowrap">{{ $message->designation ?? '-' }}
                                </td>
                                <td class="px-4 py-3 text-gray-500 text-center">{{ $message->sort_order }}</td>
                                <td class="px-4 py-3 text-center whitespace-nowrap">
                                    <span class="px-2.5 py-1 rounded-full text-xs font-medium"
                                        :class="active ? 'bg-emerald-100 text-emerald-700' :
                                        'bg-gray-100 text-gray-600'"
                                        x-text="active ? 'সক্রিয়' : 'নিষ্ক্রিয়'">{{ $message->is_active ? 'সক্রিয়' : 'নিষ্ক্রিয়' }}</span>
                                </td>
                                <td class="px-4 py-3 sticky right-0 bg-white z-10">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <button @click="openEditModal({{ $message->id }})"
                                        ...
                                        <form method="POST" action="{{ route('admin.messages.destroy', $message->id) }}"
                                            onsubmit="return confirm('আপনি কি নিশ্চিত এই বার্তাটি মুছে ফেলতে চান?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-5 py-12 text-center">
                                    ...
                                    <p class="text-sm text-gray-400 mt-1">নতুন বার্তা যোগ করুন বা অনুসন্ধান পরিবর্তন করুন</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <div x-show="showCreateModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                ...
                <div class="gradient-logo px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="font-heading font-bold text-white text-lg">নতুন বার্তা</h3>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="designation" x-model="createForm.designation"
                                ...
                                placeholder="যেমন: চেয়ারম্যান, প্রধান শিক্ষক">
                        </div>
                        <div>
                        ...
                        <div class="sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">পূর্ণাঙ্গ বার্তা <span
                                    class="text-red-500">*</span></label>
                            ...
                            <template x-if="createErrors.message || (createAttempted && !createForm.message)">
                                <p class="mt-1 text-xs text-red-600" x-text="createErrors.message || 'বার্তা আবশ্যক'"></p>
                            </template>
                        </div>
                        <div>
        ...
        <div x-show="showViewModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                class="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
                <div class="gradient-logo px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="font-heading font-bold text-white text-lg">বার্তার তথ্য</h3>
                        ...
                        <div>
                            <div class="flex items-center gap-4 mb-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500" x-text="viewData.name"></p>
                                </div>
                            </div>
                            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 text-sm">
                                <div>
                                    <dt class="text-gray-500 mb-1">পদবি</dt>
                                    <dd class="font-medium text-gray-900" x-text="viewData.designation || '-'"></dd>
                                </div>
                                <div>
                                ...
                                <div class="sm:col-span-2">
                                    <dt class="text-gray-500 mb-1">কালাম</dt>
        ...
        <div x-show="showEditModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div
                class="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
                <div class="gradient-logo px-6 py-4 flex items-center justify-between rounded-t-2xl">
                    <h3 class="font-heading font-bold text-white text-lg">বার্তা সম্পাদনা</h3>
                ...
                <div class="p-6">
                    <template x-if="editData">
                        <form :action="'{{ url('admin/messages') }}/' + editData.id" method="POST"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <template x-if="editErrors.message || (editAttempted && !editData.message)">
                                        <p class="mt-1 text-xs text-red-600" x-text="editErrors.message || 'বার্তা আবশ্যক'"></p>
                                    </template>
                                </div>
                                <div>
            ...
            function messageApp() {
                return {
                    ...
                    async openViewModal(id) {
                        ...
                        this.viewData = null;
                        try {
                            const res = await fetch(`{{ url('admin/messages') }}/${id}`);
                    ...
                    async openEditModal(id) {
                        ...
                        try {
                            const res = await fetch(`{{ url('admin/messages') }}/${id}/edit`);
                    ...
                    validateField(field, data, errors) {
                        ...
                        if (['title', 'name', 'message'].includes(field)) {
                            if (!val || val.trim() === '') {
                                const msgs = {
