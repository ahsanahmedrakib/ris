            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">বাস নং <span
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">রুটের নাম <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">আসন সংখ্যা <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">ড্রাইভারের নাম <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">ড্রাইভারের মোবাইল <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">অবস্থা <span
                                    class="text-red-500">*</span></label>
                            <select name="status" required
                                ...
                                <option value="active" {{ old('status', 'active') === 'active' ? 'selected' : '' }}>সক্রিয়
                                </option>
                                <option value="inactive" {{ old('status') === 'inactive' ? 'selected' : '' }}>ডিলিট
                                </option>
                            </select>
                        </div>
                    </div>
