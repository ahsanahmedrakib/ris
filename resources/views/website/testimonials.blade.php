            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-wrap items-center justify-center gap-4 sm:gap-6 reveal">
                    <div
                        ...
                        <div
                            class="w-12 h-12 rounded-xl bg-linear-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-md">
                        ...
                        <div>
                            <p class="font-heading font-bold text-3xl leading-none text-amber-600">★
                                {{ $testimonialStats['bangla_average'] }}</p>
                            <p class="text-xs text-gray-500 mt-1.5">গড় রেটিং</p>
                        </div>
                    </div>
                    <div
                        class="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-600 text-sm font-medium shadow-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        অ্যাডমিন কর্তৃক যাচাইকৃত
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                <div class="text-center py-16">
                    ...
                    <p class="mt-2 text-gray-500">শীঘ্রই আমাদের অভিভাবকদের মতামত যোগ করা হবে। আপনি আপনার অভিজ্ঞতা শেয়ার
                        করুন।</p>
