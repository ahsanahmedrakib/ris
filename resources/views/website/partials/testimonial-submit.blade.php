    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            fetch(form.action, {
                ...
                .then(async response => {
                    ...
                    if (response.status === 422) {
                        ...
                        if (firstError) {
                            ...
                            pushToast('error', data.message ||
                                'টেস্টিমোনিয়াল জমা দিতে সমস্যা হয়েছে। আবার চেষ্টা করুন।');
                        }
                        return;
                    }
                    ...
                    if (response.ok) {
                        pushToast('success', data.message ||
                            'আপনার টেস্টিমোনিয়াল জমা হয়েছে। প্রশাসকের অনুমোদনের পরে প্রকাশিত হবে।'
                            );
                        form.reset();
                ...
                .catch(() => {
                    pushToast('error', 'টেস্টিমোনিয়াল জমা দিতে সমস্যা হয়েছে। আবার চেষ্টা করুন।');
                })
                .finally(() => {
